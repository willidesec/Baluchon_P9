...
struct Constants {
    ...
    struct YahooWeatherCode {
        static let wind = ["0","2","23","24"]
        static let cloudy = ["26","28","30","44"]
        static let rain = ["5","6","8","9","11","12","35","40"]
        ...
        static let night = ["31", "33"]
        static let cloudyNight = ["27", "29"]
    }
